...
4. [Clickjacking](vulnerabilities/clickjacking.md)                                    
5. [DOM based vulnerabilities](vulnerabilities/dom-based-vulnerabilities.md)          
6. [Cross origin resource sharing](vulnerabilities/cross-origin-resource-sharing.md)  
7. [XML external entity injection](vulnerabilities/xml-external-entity-injection.md)  
8. [Server side request forgery](vulnerabilities/server-side-request-forgery.md)      
9. [HTTP request smuggling](vulnerabilities/http-request-smuggling.md)                
10. [OS command injection](vulnerabilities/os-command-injection.md)                    
11. [Server side template injection](vulnerabilities/server-side-template-injection.md)
12. [Path traversal](vulnerabilities/path-traversal.md)                                
13. [Access control vulnerabilities](vulnerabilities/access-control-vulnerabilities.md)
14. [Authentication](vulnerabilities/authentication.md)                                
15. [Websockets](vulnerabilities/websockets.md)                                        
16. [Web cache poisoning](vulnerabilities/web-cache-poisoning.md)                      
17. [insecure deserialization](vulnerabilities/insecure-deserialization.md)            
18. [Information disclosure](vulnerabilities/information-disclosure.md)                
19. [Business logic vulnerabilities](vulnerabilities/business-logic-vulnerabilities.md)
20. [HTTP host header attacks](vulnerabilities/http-host-header-attacks.md)            
21. [Oauth authentication](vulnerabilities/oauth-authentication.md)                    
22. [File upload vulnerabilities](vulnerabilities/file-upload-vulnerabilities.md)      
23. [JWT authentication](vulnerabilities/jwt-authentication.md)                        
24. [Essential skills](vulnerabilities/essential-skills.md)                            
25. [Prototype pollution](vulnerabilities/prototype-pollution.md)                      
26. [Graphql vulnerabilities](vulnerabilities/graphql-vulnerabilities.md)              
27. [Race-conditions](vulnerabilities/race-conditions.md)                              
28. [No SQL injection](vulnerabilities/no-sql-injection.md)                            
29. [API testing](vulnerabilities/api-testing.md)                                      
30. [Web cache deception](vulnerabilities/web-cache-deception.md)                      
31. [web llm attacks](vulnerabilities/web-llm-attacks.md)                              
